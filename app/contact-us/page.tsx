...
export default function ContactPage() {
    return (
        <div className="items-center bg-green-a space-y-20 px-4 md:px-12 lg:px-16 pb-12">
            <FadeInDiv id="general-form" className="sm:grid sm:grid-cols-2 text-white py-10">
            ...
            <FadeInDiv id="business-form" className="sm:grid sm:grid-cols-2 bg-orange-a rounded-md text-black bottom-8 p-10">
                <div className="sm:place-self-center hidden sm:block">

...
export default function MemberCard({ imageSrc, name, role }: MemberCardProps) {
  return (
    <div className="max-w-[350] flex flex-col bg-white rounded-md shadow-md overflow-hidden">
      <div className="relative aspect-square">
        <Image src={imageSrc} alt={name} fill={true} objectFit="cover" />
      </div>
      <div className="w-full h-[100] flex flex-col items-center justify-center space-y-1">
